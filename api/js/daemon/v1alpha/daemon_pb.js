...
goog.exportSymbol('proto.com.mintter.daemon.v1alpha.GetInfoRequest', null, global);
goog.exportSymbol('proto.com.mintter.daemon.v1alpha.Info', null, global);
 ...
 * @constructor
 */
proto.com.mintter.daemon.v1alpha.GetInfoRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.com.mintter.daemon.v1alpha.GetInfoRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.com.mintter.daemon.v1alpha.GetInfoRequest.displayName = 'proto.com.mintter.daemon.v1alpha.GetInfoRequest';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.com.mintter.daemon.v1alpha.Info = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.com.mintter.daemon.v1alpha.Info, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.com.mintter.daemon.v1alpha.Info.displayName = 'proto.com.mintter.daemon.v1alpha.Info';
}
 ...
 * @return {!Object}
 */
proto.com.mintter.daemon.v1alpha.GetInfoRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.com.mintter.daemon.v1alpha.GetInfoRequest.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.com.mintter.daemon.v1alpha.GetInfoRequest} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.com.mintter.daemon.v1alpha.GetInfoRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.com.mintter.daemon.v1alpha.GetInfoRequest}
 */
proto.com.mintter.daemon.v1alpha.GetInfoRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.com.mintter.daemon.v1alpha.GetInfoRequest;
  return proto.com.mintter.daemon.v1alpha.GetInfoRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.com.mintter.daemon.v1alpha.GetInfoRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.com.mintter.daemon.v1alpha.GetInfoRequest}
 */
proto.com.mintter.daemon.v1alpha.GetInfoRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.com.mintter.daemon.v1alpha.GetInfoRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.com.mintter.daemon.v1alpha.GetInfoRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.com.mintter.daemon.v1alpha.GetInfoRequest} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.com.mintter.daemon.v1alpha.GetInfoRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
};
 ...
 * @return {!Object}
 */
proto.com.mintter.daemon.v1alpha.Info.prototype.toObject = function(opt_includeInstance) {
  return proto.com.mintter.daemon.v1alpha.Info.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.com.mintter.daemon.v1alpha.Info} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.com.mintter.daemon.v1alpha.Info.toObject = function(includeInstance, msg) {
  var f, obj = {
    accountId: jspb.Message.getFieldWithDefault(msg, 1, ""),
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.com.mintter.daemon.v1alpha.Info}
 */
proto.com.mintter.daemon.v1alpha.Info.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.com.mintter.daemon.v1alpha.Info;
  return proto.com.mintter.daemon.v1alpha.Info.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.com.mintter.daemon.v1alpha.Info} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.com.mintter.daemon.v1alpha.Info}
 */
proto.com.mintter.daemon.v1alpha.Info.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.com.mintter.daemon.v1alpha.Info.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.com.mintter.daemon.v1alpha.Info.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.com.mintter.daemon.v1alpha.Info} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.com.mintter.daemon.v1alpha.Info.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getAccountId();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.com.mintter.daemon.v1alpha.Info.prototype.getAccountId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.com.mintter.daemon.v1alpha.Info} returns this
 */
proto.com.mintter.daemon.v1alpha.Info.prototype.setAccountId = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {string}
 */
proto.com.mintter.daemon.v1alpha.Info.prototype.getPeerId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.com.mintter.daemon.v1alpha.Info} returns this
 */
proto.com.mintter.daemon.v1alpha.Info.prototype.setPeerId = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};
 ...
 */
proto.com.mintter.daemon.v1alpha.Info.prototype.getStartTime = function() {
 ...
 * @return {!proto.com.mintter.daemon.v1alpha.Info} returns this
*/
proto.com.mintter.daemon.v1alpha.Info.prototype.setStartTime = function(value) {
 ...
 * @return {!proto.com.mintter.daemon.v1alpha.Info} returns this
 */
proto.com.mintter.daemon.v1alpha.Info.prototype.clearStartTime = function() {
 ...
 * @return {boolean}
 */
proto.com.mintter.daemon.v1alpha.Info.prototype.hasStartTime = function() {
