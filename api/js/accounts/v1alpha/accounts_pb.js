...
goog.exportSymbol('proto.com.mintter.accounts.v1alpha.StartAccountDiscoveryRequest', null, global);
goog.exportSymbol('proto.com.mintter.accounts.v1alpha.StartAccountDiscoveryResponse', null, global);
/**
 ...
 * @constructor
 */
proto.com.mintter.accounts.v1alpha.StartAccountDiscoveryRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.com.mintter.accounts.v1alpha.StartAccountDiscoveryRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.com.mintter.accounts.v1alpha.StartAccountDiscoveryRequest.displayName = 'proto.com.mintter.accounts.v1alpha.StartAccountDiscoveryRequest';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.com.mintter.accounts.v1alpha.StartAccountDiscoveryResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.com.mintter.accounts.v1alpha.StartAccountDiscoveryResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.com.mintter.accounts.v1alpha.StartAccountDiscoveryResponse.displayName = 'proto.com.mintter.accounts.v1alpha.StartAccountDiscoveryResponse';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {!Object}
 */
proto.com.mintter.accounts.v1alpha.StartAccountDiscoveryRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.com.mintter.accounts.v1alpha.StartAccountDiscoveryRequest.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.com.mintter.accounts.v1alpha.StartAccountDiscoveryRequest} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.com.mintter.accounts.v1alpha.StartAccountDiscoveryRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.com.mintter.accounts.v1alpha.StartAccountDiscoveryRequest}
 */
proto.com.mintter.accounts.v1alpha.StartAccountDiscoveryRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.com.mintter.accounts.v1alpha.StartAccountDiscoveryRequest;
  return proto.com.mintter.accounts.v1alpha.StartAccountDiscoveryRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.com.mintter.accounts.v1alpha.StartAccountDiscoveryRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.com.mintter.accounts.v1alpha.StartAccountDiscoveryRequest}
 */
proto.com.mintter.accounts.v1alpha.StartAccountDiscoveryRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.com.mintter.accounts.v1alpha.StartAccountDiscoveryRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.com.mintter.accounts.v1alpha.StartAccountDiscoveryRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.com.mintter.accounts.v1alpha.StartAccountDiscoveryRequest} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.com.mintter.accounts.v1alpha.StartAccountDiscoveryRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 * @return {string}
 */
proto.com.mintter.accounts.v1alpha.StartAccountDiscoveryRequest.prototype.getAccountId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.com.mintter.accounts.v1alpha.StartAccountDiscoveryRequest} returns this
 */
proto.com.mintter.accounts.v1alpha.StartAccountDiscoveryRequest.prototype.setAccountId = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {!Object}
 */
proto.com.mintter.accounts.v1alpha.StartAccountDiscoveryResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.com.mintter.accounts.v1alpha.StartAccountDiscoveryResponse.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.com.mintter.accounts.v1alpha.StartAccountDiscoveryResponse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.com.mintter.accounts.v1alpha.StartAccountDiscoveryResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.com.mintter.accounts.v1alpha.StartAccountDiscoveryResponse}
 */
proto.com.mintter.accounts.v1alpha.StartAccountDiscoveryResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.com.mintter.accounts.v1alpha.StartAccountDiscoveryResponse;
  return proto.com.mintter.accounts.v1alpha.StartAccountDiscoveryResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.com.mintter.accounts.v1alpha.StartAccountDiscoveryResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.com.mintter.accounts.v1alpha.StartAccountDiscoveryResponse}
 */
proto.com.mintter.accounts.v1alpha.StartAccountDiscoveryResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.com.mintter.accounts.v1alpha.StartAccountDiscoveryResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.com.mintter.accounts.v1alpha.StartAccountDiscoveryResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.com.mintter.accounts.v1alpha.StartAccountDiscoveryResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.com.mintter.accounts.v1alpha.StartAccountDiscoveryResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
};
