...
export const isFlowContent = isOneOfTypes<FlowContent>(['statement', 'blockquote', 'heading', 'code', 'callout'])
export const isGroupContent = isOneOfTypes<GroupingContent>(['group', 'orderedList', 'unorderedList'])
export const isStaticPhrasingContent = isOneOfTypes<StaticPhrasingContent>(['text', 'video', 'image'])
export const isPhrasingContent = isOneOfTypes<PhrasingContent>(['text', 'link', 'embed', 'video', 'image'])
