...
var require_FocusScope = __commonJS({
  '../../node_modules/.pnpm/@tamagui+focus-scope@1.7.7_react@18.2.0/node_modules/@tamagui/focus-scope/dist/cjs/FocusScope.js'(
    ...
    var import_compose_refs14 = require_cjs2()
  ...
  '../../node_modules/.pnpm/@tamagui+get-size@1.7.7_react@18.2.0/node_modules/@tamagui/get-size/dist/cjs/index.js'(
    ...
    var stepTokenUpOrDown5 = /* @__PURE__ */ __name(
      (type, name = '$true', shift2 = 0, bounds = [0]) => {
        const tokens = (0, import_core50.getTokens)({prefixed: true})[type]
        const keysOrdered =
          import_core50.tokensKeysOrdered.get(tokens) || Object.keys(tokens)
...
var require_getSpace = __commonJS({
  '../../node_modules/.pnpm/@tamagui+helpers-tamagui@1.7.7_react@18.2.0/node_modules/@tamagui/helpers-tamagui/dist/cjs/getSpace.js'(
    ...
    var getSpace = /* @__PURE__ */ __name((token, sizeUpOrDownBy = 0) => {
      const spaces = (0, import_core50.getTokens)().space
...
var require_getElevation = __commonJS({
  '../../node_modules/.pnpm/@tamagui+stacks@1.7.7_react@18.2.0/node_modules/@tamagui/stacks/dist/cjs/getElevation.js'(
    ...
    var getElevation2 = /* @__PURE__ */ __name((size2, extras) => {
      ...
      const sizeNum = (0, import_core50.isVariable)(token) ? +token.val : size2
      return getSizedElevation2(sizeNum, extras)
    }, 'getElevation')
    var getSizedElevation2 = /* @__PURE__ */ __name((val, {theme, tokens}) => {
      let num = 0
      if (val === true) {
        const val2 = (0, import_core50.getVariableValue)(tokens.size['true'])
...
var require_Group = __commonJS({
  '../../node_modules/.pnpm/@tamagui+group@1.7.7_react@18.2.0/node_modules/@tamagui/group/dist/cjs/Group.js'(
    ...
    var import_jsx_runtime43 = require('react/jsx-runtime')
    var import_core50 = require('@tamagui/core-node')
    var import_create_context18 = require_cjs13()
    var import_stacks25 = require_cjs14()
    var import_use_controllable_state12 = require_cjs15()
    ...
    var GroupFrame = (0, import_core50.styled)(import_stacks25.ThemeableStack, {
      ...
      variants: {
        ...
        size: (val, {tokens}) => {
          const borderRadius =
            tokens.radius[val] ?? val ?? tokens.radius['$true']
          return {
            borderRadius,
          }
        },
          ...
          const radius =
            ...
            (size2
              ? (0, import_core50.getVariableValue)(
                  (0, import_core50.getTokens)().radius[size2],
                ) - 1
              : void 0)
    ...
    var getBorderRadius = /* @__PURE__ */ __name(
      ({isFirst, isLast, radius, vertical, disable}) => {
        return {
          borderTopLeftRadius:
  ...
  '../../node_modules/.pnpm/@tamagui+focusable@1.7.7_react@18.2.0/node_modules/@tamagui/focusable/dist/cjs/focusableInputHOC.js'(
    ...
    function focusableInputHOC3(Component) {
      const component = Component.extractable(
        (0, import_react37.forwardRef)((props, ref) => {
          const isInput =
            (0, import_web13.isTamaguiComponent)(Component) &&
...
function useButton(propsIn, {Text: Text5 = ButtonText} = {Text: ButtonText}) {
  ...
  const isNested = import_web8.isRSC
    ? false
    : (0, import_react15.useContext)(import_web8.ButtonNestingContext)
  const propsActive = (0, import_web8.useMediaPropsActive)(propsIn)
  const size2 = propsActive.size || '$true'
  const iconSize =
    (typeof size2 === 'number'
      ? size2 * 0.5
      : (0, import_font_size.getFontSize)(size2)) * scaleIcon
  ...
  const spaceSize =
    propsActive.space ??
    (0, import_web8.getVariableValue)(iconSize) * scaleSpace
  ...
  const props = {
    ...
    tag,
    ...rest,
    children: import_web8.isRSC
      ? inner2
      : /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(
          import_web8.ButtonNestingContext.Provider,
        ...
        return (
          ...
          /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(CardFrame, {
            ...
            children: import_react16.default.Children.map(children, (child) => {
              if (
                (0, import_web9.isTamaguiElement)(child) &&
                !child.props.size
              ) {
...
var Label = LabelFrame.extractable(
  (0, import_web10.themeable)(LabelComponent),
  {
    neverFlatten: true,
  },
)
...
var computePosition = /* @__PURE__ */ __name(
  async (reference, floating, config) => {
    const {
      placement = 'bottom',
      strategy = 'absolute',
      middleware = [],
...
var SelectContent = /* @__PURE__ */ __name(
  ({children, __scopeSelect, zIndex = 1e3, ...focusScopeProps}) => {
...
var SliderThumb = React28.forwardRef((props, forwardedRef) => {
  ...
  const thumbInBoundsOffset = size2
    ? getThumbInBoundsOffset(size2, percent, orientation.direction)
    : 0
  React28.useEffect(() => {
    if (thumb) {
...
var SwitchThumb = SwitchThumbFrame.extractable(
  React29.forwardRef((props, forwardedRef) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime32.jsx)(SwitchThumbFrame, {
      ...
      ...thumbProps,
      x: checked
        ? (0, import_core32.getVariableValue)(getSwitchWidth(size2)) -
          (0, import_core32.getVariableValue)(getSwitchHeight(size2))
        : 0,
      ref: forwardedRef,
    })
  }),
...
var TabsTrigger = TabsTriggerFrame.extractable(
  React32.forwardRef((props, forwardedRef) => {
    ...
    React32.useEffect(() => {
      if (!triggerRef.current || !import_web11.isWeb) return
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime35.jsx)(import_web11.Theme, {
      forceClassName: true,
        ...
        RovingFocusGroup.Item,
        {
          ...
          children: /* @__PURE__ */ (0, import_jsx_runtime35.jsx)(
            TabsTriggerFrame,
            {
              ...
              onHoverIn: (0, import_web11.composeEventHandlers)(
                props.onHoverIn,
                () => {
                  if (layout) {
                    onInteraction == null
              ...
              onHoverOut: (0, import_web11.composeEventHandlers)(
                props.onHoverOut,
                () => {
              ...
              onPress: (0, import_web11.composeEventHandlers)(
              ...
              ...(import_web11.isWeb && {
                ...
                onFocus: (0, import_web11.composeEventHandlers)(
                  props.onFocus,
                  (event) => {
                    if (layout) {
                      onInteraction == null
                ...
                onBlur: (0, import_web11.composeEventHandlers)(
                  props.onFocus,
                  () => {
                    onInteraction == null
                      ? void 0
...
var Tabs = (0, import_web11.withStaticProperties)(
  React32.forwardRef((props, forwardedRef) => {
    ...
    const registerTrigger = (0, import_web11.useEvent)(() =>
      setTriggersCount((v) => v + 1),
    )
    const unregisterTrigger = (0, import_web11.useEvent)(() =>
      setTriggersCount((v) => v - 1),
    )
    return /* @__PURE__ */ (0, import_jsx_runtime35.jsx)(TabsProvider, {
      scope: __scopeTabs,
      baseId: (0, import_web11.useId)(),
      value,
      onChange: setValue,
      orientation,
      dir: direction,
...
var VisuallyHidden = (0, import_web12.styled)(import_web12.Stack, {
  position: 'absolute',
  width: 1,
  height: 1,
  margin: -1,
...
var Spinner = YStack.extractable(
  (0, import_core47.themeable)(
    React36.forwardRef((props, ref) => {
      ...
      let color = colorProp
      if (color && color[0] === '$') {
        color = (0, import_core47.variableToString)(theme[color])
      }
