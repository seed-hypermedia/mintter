...
export interface Typegen0 {
  ...
  internalEvents: {
    '': {type: ''}
    'done.invoke.getBlock': {
      type: 'done.invoke.getBlock'
      data: unknown
      __tip: 'See the XState TS docs to learn how to strongly type this.'
    }
    'done.invoke.getPublication': {
      type: 'done.invoke.getPublication'
      data: unknown
      __tip: 'See the XState TS docs to learn how to strongly type this.'
    }
    'error.platform.getBlock': {type: 'error.platform.getBlock'; data: unknown}
    'error.platform.getPublication': {
      type: 'error.platform.getPublication'
      data: unknown
    }
