...
export interface Typegen0 {
  '@@xstate/typegen': true
  internalEvents: {
    'done.invoke.boundsListener': {
      type: 'done.invoke.boundsListener'
      data: unknown
      __tip: 'See the XState TS docs to learn how to strongly type this.'
    }
    'done.invoke.windowBlurService': {
      type: 'done.invoke.windowBlurService'
      data: unknown
      __tip: 'See the XState TS docs to learn how to strongly type this.'
    }
    'done.invoke.windowListener': {
      type: 'done.invoke.windowListener'
      data: unknown
      __tip: 'See the XState TS docs to learn how to strongly type this.'
    }
    'done.invoke.windowResizeService': {
      type: 'done.invoke.windowResizeService'
      data: unknown
      __tip: 'See the XState TS docs to learn how to strongly type this.'
    }
