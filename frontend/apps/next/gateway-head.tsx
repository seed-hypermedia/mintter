      ...
      <Container my="$7">
        <XStack ai="center" jc="space-between">
          <Link href="/" aria-label="home page">
            <YStack cur="pointer">
              <Image src="/logo-blue.svg" alt="Mintter logo" width={136} height={48} />
            </YStack>
          </Link>
          {media.gtSm ? (
            <XStack space="$3" ai="center">
              <MenuItem href="https://github.com/mintterteam/mintter" target="_blank">
                Github
              </MenuItem>
              ...
              >
                ...
                <Popover.ScrollView showsVerticalScrollIndicator={false} style={{ flex: 1 }}>
                  ...
                  >
                    ...
                    <NextLink href="https://github.com/mintterteam/mintter" target="_blank">
                      <HeadAnchor>Github</HeadAnchor>
                    </NextLink>
                    <NextLink href="https://discord.gg/mcUnKENdKX" target="_blank">
                      <HeadAnchor>Discord</HeadAnchor>
                    </NextLink>

                    <NextLink href="https://twitter.com/mintterteam" target="_blank">
