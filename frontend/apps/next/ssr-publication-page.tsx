...
export default function PublicationPage({
  ...
  const slateChildren = blockChildren ? blockNodeToSlate(blockChildren, 'group') : undefined
    ...
    <>
      ...
      <Container tag="main" id="main-content" tabIndex={-1}>
        <ArticleContainer fd={media.gtSm ? 'row' : 'column-reverse'}>
          ...
          <SideContainer>
            {metadata ? <PublicationMetadata publication={publication} author={author} /> : null}
          </SideContainer>
        </ArticleContainer>
      </Container>
