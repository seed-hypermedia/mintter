...
export type NetworkingDefinition = typeof NetworkingDefinition;
export const NetworkingDefinition = {
  name: "Networking",
  fullName: "com.mintter.networking.v1alpha.Networking",
  methods: {
...
export interface NetworkingServiceImplementation<CallContextExt = {}> {
  /** Lookup details about a known peer. */
  getPeerInfo(request: GetPeerInfoRequest, context: CallContext & CallContextExt): Promise<DeepPartial<PeerInfo>>;
  /** Establishes a direct connection with a given peer explicitly. */
  connect(request: ConnectRequest, context: CallContext & CallContextExt): Promise<DeepPartial<ConnectResponse>>;
}

export interface NetworkingClient<CallOptionsExt = {}> {
  /** Lookup details about a known peer. */
  getPeerInfo(request: DeepPartial<GetPeerInfoRequest>, options?: CallOptions & CallOptionsExt): Promise<PeerInfo>;
  /** Establishes a direct connection with a given peer explicitly. */
