...
export type DraftsDefinition = typeof DraftsDefinition;
export const DraftsDefinition = {
  name: "Drafts",
  fullName: "com.mintter.documents.v1alpha.Drafts",
  methods: {
    ...
    updateDraftV2: {
      name: "UpdateDraftV2",
      requestType: UpdateDraftRequestV2,
      requestStream: false,
      responseType: Empty,
      responseStream: false,
      options: {},
    ...
    publishDraft: {
      name: "PublishDraft",
      requestType: PublishDraftRequest,
      requestStream: false,
      responseType: Publication,
      responseStream: false,
      options: {},
    },
  },
...
export interface DraftsServiceImplementation<CallContextExt = {}> {
  /** Creates a new draft with a new permanent document ID. */
  createDraft(request: CreateDraftRequest, context: CallContext & CallContextExt): Promise<DeepPartial<Document>>;
  /** Deletes a draft by its document ID. */
  deleteDraft(request: DeleteDraftRequest, context: CallContext & CallContextExt): Promise<DeepPartial<Empty>>;
  /** Gets a single draft if exists. */
  getDraft(request: GetDraftRequest, context: CallContext & CallContextExt): Promise<DeepPartial<Document>>;
  /** Updates a draft using granular update operations. */
  updateDraftV2(request: UpdateDraftRequestV2, context: CallContext & CallContextExt): Promise<DeepPartial<Empty>>;
  /** List currently stored drafts. */
  listDrafts(
  ...
  /** Publishes a draft. I.e. draft will become a publication, and will no longer appear in drafts section. */
  publishDraft(request: PublishDraftRequest, context: CallContext & CallContextExt): Promise<DeepPartial<Publication>>;
}

export interface DraftsClient<CallOptionsExt = {}> {
  /** Creates a new draft with a new permanent document ID. */
  createDraft(request: DeepPartial<CreateDraftRequest>, options?: CallOptions & CallOptionsExt): Promise<Document>;
  /** Deletes a draft by its document ID. */
  deleteDraft(request: DeepPartial<DeleteDraftRequest>, options?: CallOptions & CallOptionsExt): Promise<Empty>;
  /** Gets a single draft if exists. */
  getDraft(request: DeepPartial<GetDraftRequest>, options?: CallOptions & CallOptionsExt): Promise<Document>;
  /** Updates a draft using granular update operations. */
  updateDraftV2(request: DeepPartial<UpdateDraftRequestV2>, options?: CallOptions & CallOptionsExt): Promise<Empty>;
  /** List currently stored drafts. */
  listDrafts(
  ...
  /** Publishes a draft. I.e. draft will become a publication, and will no longer appear in drafts section. */
  publishDraft(request: DeepPartial<PublishDraftRequest>, options?: CallOptions & CallOptionsExt): Promise<Publication>;
}

/** Publications service provides access to published documents. */
export type PublicationsDefinition = typeof PublicationsDefinition;
export const PublicationsDefinition = {
  name: "Publications",
  fullName: "com.mintter.documents.v1alpha.Publications",
  methods: {
    /** Gets a single publication. */
    getPublication: {
      name: "GetPublication",
      requestType: GetPublicationRequest,
      requestStream: false,
      responseType: Publication,
      responseStream: false,
      options: {},
    ...
    deletePublication: {
      ...
      requestType: DeletePublicationRequest,
      requestStream: false,
      responseType: Empty,
      responseStream: false,
      options: {},
    ...
    listPublications: {
      ...
      requestType: ListPublicationsRequest,
      requestStream: false,
      responseType: ListPublicationsResponse,
      responseStream: false,
      options: {},
    },
  },
...
export interface PublicationsServiceImplementation<CallContextExt = {}> {
  /** Gets a single publication. */
  getPublication(
    request: GetPublicationRequest,
    context: CallContext & CallContextExt,
  ): Promise<DeepPartial<Publication>>;
  /** Deletes a publication from the local node. It removes all the patches corresponding to a document. */
  deletePublication(
  ...
  listPublications(
    ...
    context: CallContext & CallContextExt,
  ): Promise<DeepPartial<ListPublicationsResponse>>;
}

export interface PublicationsClient<CallOptionsExt = {}> {
  /** Gets a single publication. */
  getPublication(
...
export type ContentGraphDefinition = typeof ContentGraphDefinition;
export const ContentGraphDefinition = {
  name: "ContentGraph",
  fullName: "com.mintter.documents.v1alpha.ContentGraph",
  methods: {
    listCitations: {
      name: "ListCitations",
      requestType: ListCitationsRequest,
      requestStream: false,
      responseType: ListCitationsResponse,
      responseStream: false,
      options: {},
    },
  },
...
export interface ContentGraphServiceImplementation<CallContextExt = {}> {
  listCitations(
    request: ListCitationsRequest,
    context: CallContext & CallContextExt,
  ): Promise<DeepPartial<ListCitationsResponse>>;
}

export interface ContentGraphClient<CallOptionsExt = {}> {
  listCitations(
