...
export const InitProfileRequest = {
  encode(message: InitProfileRequest, writer: Writer = Writer.create()): Writer {
...
export const UpdateProfileRequest = {
  encode(message: UpdateProfileRequest, writer: Writer = Writer.create()): Writer {
...
export const UpdateProfileResponse = {
  encode(message: UpdateProfileResponse, writer: Writer = Writer.create()): Writer {
    if (message.profile !== undefined) {
      Profile.encode(message.profile, writer.uint32(10).fork()).ldelim()
    }
    return writer
...
export const GetProfileResponse = {
  encode(message: GetProfileResponse, writer: Writer = Writer.create()): Writer {
    if (message.profile !== undefined) {
      Profile.encode(message.profile, writer.uint32(10).fork()).ldelim()
    }
...
export const ListProfilesRequest = {
  encode(message: ListProfilesRequest, writer: Writer = Writer.create()): Writer {
...
export const ListProfilesResponse = {
  encode(message: ListProfilesResponse, writer: Writer = Writer.create()): Writer {
...
export const ListSuggestedProfilesRequest = {
  encode(message: ListSuggestedProfilesRequest, writer: Writer = Writer.create()): Writer {
    if (message.pageSize !== 0) {
      writer.uint32(8).int32(message.pageSize)
    }
    if (message.pageToken !== '') {
  ...
  decode(input: Reader | Uint8Array, length?: number): ListSuggestedProfilesRequest {
    const reader = input instanceof Reader ? input : new Reader(input)
    let end = length === undefined ? reader.len : reader.pos + length
    const message = {...baseListSuggestedProfilesRequest} as ListSuggestedProfilesRequest
    while (reader.pos < end) {
      const tag = reader.uint32()
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(object: DeepPartial<ListSuggestedProfilesRequest>): ListSuggestedProfilesRequest {
    const message = {...baseListSuggestedProfilesRequest} as ListSuggestedProfilesRequest
    if (object.pageSize !== undefined && object.pageSize !== null) {
      message.pageSize = object.pageSize
    } else {
...
export const ListSuggestedProfilesResponse = {
  encode(message: ListSuggestedProfilesResponse, writer: Writer = Writer.create()): Writer {
    for (const v of message.profiles) {
  ...
  decode(input: Reader | Uint8Array, length?: number): ListSuggestedProfilesResponse {
    const reader = input instanceof Reader ? input : new Reader(input)
    let end = length === undefined ? reader.len : reader.pos + length
    const message = {...baseListSuggestedProfilesResponse} as ListSuggestedProfilesResponse
    message.profiles = []
    while (reader.pos < end) {
      const tag = reader.uint32()
      switch (tag >>> 3) {
        case 1:
          message.profiles.push(SuggestedProfile.decode(reader, reader.uint32()))
          break
        case 2:
          message.nextPageToken = reader.string()
          break
  ...
  toJSON(message: ListSuggestedProfilesResponse): unknown {
    const obj: any = {}
    if (message.profiles) {
      obj.profiles = message.profiles.map((e) => (e ? SuggestedProfile.toJSON(e) : undefined))
    } else {
      obj.profiles = []
    }
    message.nextPageToken !== undefined && (obj.nextPageToken = message.nextPageToken)
  ...
  fromPartial(object: DeepPartial<ListSuggestedProfilesResponse>): ListSuggestedProfilesResponse {
    const message = {...baseListSuggestedProfilesResponse} as ListSuggestedProfilesResponse
    message.profiles = []
    if (object.profiles !== undefined && object.profiles !== null) {
      for (const e of object.profiles) {
...
export const GetProfileAddrsResponse = {
  encode(message: GetProfileAddrsResponse, writer: Writer = Writer.create()): Writer {
  ...
  decode(input: Reader | Uint8Array, length?: number): GetProfileAddrsResponse {
    const reader = input instanceof Reader ? input : new Reader(input)
    let end = length === undefined ? reader.len : reader.pos + length
    const message = {...baseGetProfileAddrsResponse} as GetProfileAddrsResponse
    message.addrs = []
    while (reader.pos < end) {
      const tag = reader.uint32()
      switch (tag >>> 3) {
  ...
  fromPartial(object: DeepPartial<GetProfileAddrsResponse>): GetProfileAddrsResponse {
    const message = {...baseGetProfileAddrsResponse} as GetProfileAddrsResponse
    message.addrs = []
    if (object.addrs !== undefined && object.addrs !== null) {
      for (const e of object.addrs) {
...
export const ConnectToPeerRequest = {
  encode(message: ConnectToPeerRequest, writer: Writer = Writer.create()): Writer {
    for (const v of message.addrs) {
      writer.uint32(10).string(v!)
    }
    return writer
...
const baseProfile: object = {peerId: '', accountId: '', username: '', email: '', bio: '', connectionStatus: 0}
...
export const Config = {
  ...
  toJSON(message: Config): unknown {
    ...
    message.homePageUri !== undefined && (obj.homePageUri = message.homePageUri)
    return obj
  },
...
export interface Mintter {
   ...
   */
  initProfile(request: DeepPartial<InitProfileRequest>, metadata?: grpc.Metadata): Promise<InitProfileResponse>
  /**
  ...
  connectToPeer(request: DeepPartial<ConnectToPeerRequest>, metadata?: grpc.Metadata): Promise<ConnectToPeerResponse>
}
...
export class MintterClientImpl implements Mintter {
  ...
  GenSeed(request: DeepPartial<GenSeedRequest>, metadata?: grpc.Metadata): Promise<GenSeedResponse> {
    return this.rpc.unary(MintterGenSeedDesc, GenSeedRequest.fromPartial(request), metadata)
  }

  InitProfile(request: DeepPartial<InitProfileRequest>, metadata?: grpc.Metadata): Promise<InitProfileResponse> {
    return this.rpc.unary(MintterInitProfileDesc, InitProfileRequest.fromPartial(request), metadata)
  }

  GetProfile(request: DeepPartial<GetProfileRequest>, metadata?: grpc.Metadata): Promise<GetProfileResponse> {
    return this.rpc.unary(MintterGetProfileDesc, GetProfileRequest.fromPartial(request), metadata)
  }

  UpdateProfile(request: DeepPartial<UpdateProfileRequest>, metadata?: grpc.Metadata): Promise<UpdateProfileResponse> {
    return this.rpc.unary(MintterUpdateProfileDesc, UpdateProfileRequest.fromPartial(request), metadata)
  }

  ListProfiles(request: DeepPartial<ListProfilesRequest>, metadata?: grpc.Metadata): Promise<ListProfilesResponse> {
    return this.rpc.unary(MintterListProfilesDesc, ListProfilesRequest.fromPartial(request), metadata)
  }
  ...
  ListSuggestedProfiles(
    ...
    return this.rpc.unary(MintterListSuggestedProfilesDesc, ListSuggestedProfilesRequest.fromPartial(request), metadata)
  }
  ...
  GetProfileAddrs(
    ...
    return this.rpc.unary(MintterGetProfileAddrsDesc, GetProfileAddrsRequest.fromPartial(request), metadata)
  }

  ConnectToPeer(request: DeepPartial<ConnectToPeerRequest>, metadata?: grpc.Metadata): Promise<ConnectToPeerResponse> {
    return this.rpc.unary(MintterConnectToPeerDesc, ConnectToPeerRequest.fromPartial(request), metadata)
  }
}
