...
export const UpdateDraftRequest = {
  encode(message: UpdateDraftRequest, writer: Writer = Writer.create()): Writer {
    ...
    Object.entries(message.blocks).forEach(([key, value]) => {
      UpdateDraftRequest_BlocksEntry.encode({key: key as any, value}, writer.uint32(18).fork()).ldelim()
    })
    return writer
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          break
        case 2:
          const entry2 = UpdateDraftRequest_BlocksEntry.decode(reader, reader.uint32())
...
export const UpdateDraftRequest_BlocksEntry = {
  encode(message: UpdateDraftRequest_BlocksEntry, writer: Writer = Writer.create()): Writer {
    if (message.key !== '') {
  ...
  decode(input: Reader | Uint8Array, length?: number): UpdateDraftRequest_BlocksEntry {
    const reader = input instanceof Reader ? input : new Reader(input)
    let end = length === undefined ? reader.len : reader.pos + length
    const message = {...baseUpdateDraftRequest_BlocksEntry} as UpdateDraftRequest_BlocksEntry
    while (reader.pos < end) {
      const tag = reader.uint32()
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(object: DeepPartial<UpdateDraftRequest_BlocksEntry>): UpdateDraftRequest_BlocksEntry {
    const message = {...baseUpdateDraftRequest_BlocksEntry} as UpdateDraftRequest_BlocksEntry
    if (object.key !== undefined && object.key !== null) {
...
export const GetDocumentRequest = {
  encode(message: GetDocumentRequest, writer: Writer = Writer.create()): Writer {
    if (message.version !== '') {
      writer.uint32(10).string(message.version)
    }
    if (message.id !== '') {
...
export const GetDocumentResponse = {
  encode(message: GetDocumentResponse, writer: Writer = Writer.create()): Writer {
    if (message.document !== undefined) {
      Document.encode(message.document, writer.uint32(10).fork()).ldelim()
    }
    Object.entries(message.blocks).forEach(([key, value]) => {
      GetDocumentResponse_BlocksEntry.encode({key: key as any, value}, writer.uint32(18).fork()).ldelim()
    })
    return writer
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          break
        case 2:
          const entry2 = GetDocumentResponse_BlocksEntry.decode(reader, reader.uint32())
          if (entry2.value !== undefined) {
            message.blocks[entry2.key] = entry2.value
          }
          break
...
export const GetDocumentResponse_BlocksEntry = {
  encode(message: GetDocumentResponse_BlocksEntry, writer: Writer = Writer.create()): Writer {
    if (message.key !== '') {
      writer.uint32(10).string(message.key)
    }
    if (message.value !== undefined) {
  ...
  decode(input: Reader | Uint8Array, length?: number): GetDocumentResponse_BlocksEntry {
    const reader = input instanceof Reader ? input : new Reader(input)
    let end = length === undefined ? reader.len : reader.pos + length
    const message = {...baseGetDocumentResponse_BlocksEntry} as GetDocumentResponse_BlocksEntry
    while (reader.pos < end) {
      const tag = reader.uint32()
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(object: DeepPartial<GetDocumentResponse_BlocksEntry>): GetDocumentResponse_BlocksEntry {
    const message = {...baseGetDocumentResponse_BlocksEntry} as GetDocumentResponse_BlocksEntry
    if (object.key !== undefined && object.key !== null) {
      message.key = object.key
    } else {
...
const baseListDocumentsRequest: object = {pageSize: 0, pageToken: '', publishingState: 0, author: ''}

export const ListDocumentsRequest = {
  encode(message: ListDocumentsRequest, writer: Writer = Writer.create()): Writer {
  ...
  fromJSON(object: any): ListDocumentsRequest {
    ...
    if (object.publishingState !== undefined && object.publishingState !== null) {
  ...
  toJSON(message: ListDocumentsRequest): unknown {
    ...
    message.publishingState !== undefined && (obj.publishingState = publishingStateToJSON(message.publishingState))
...
export const ListDocumentsResponse = {
  encode(message: ListDocumentsResponse, writer: Writer = Writer.create()): Writer {
...
export const DeleteDocumentRequest = {
  encode(message: DeleteDocumentRequest, writer: Writer = Writer.create()): Writer {
    if (message.version !== '') {
      writer.uint32(10).string(message.version)
    }
    return writer
...
const baseDocument: object = {id: '', title: '', subtitle: '', author: '', version: '', parent: '', publishingState: 0}
...
export const Document = {
  encode(message: Document, writer: Writer = Writer.create()): Writer {
    ...
    if (message.blockRefList !== undefined) {
      BlockRefList.encode(message.blockRefList, writer.uint32(66).fork()).ldelim()
    }
  ...
  toJSON(message: Document): unknown {
    ...
    message.publishingState !== undefined && (obj.publishingState = publishingStateToJSON(message.publishingState))
    message.blockRefList !== undefined &&
      (obj.blockRefList = message.blockRefList ? BlockRefList.toJSON(message.blockRefList) : undefined)
...
export const BlockRefList = {
  ...
  toJSON(message: BlockRefList): unknown {
    const obj: any = {}
    message.style !== undefined && (obj.style = blockRefList_StyleToJSON(message.style))
    if (message.refs) {
...
export const BlockRef = {
  encode(message: BlockRef, writer: Writer = Writer.create()): Writer {
    ...
    if (message.blockRefList !== undefined) {
      BlockRefList.encode(message.blockRefList, writer.uint32(18).fork()).ldelim()
    }
    return writer
  },
...
export const Block = {
  ...
  toJSON(message: Block): unknown {
    ...
    message.paragraph !== undefined &&
      (obj.paragraph = message.paragraph ? Paragraph.toJSON(message.paragraph) : undefined)
...
export const Paragraph = {
  ...
  decode(input: Reader | Uint8Array, length?: number): Paragraph {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.inlineElements.push(InlineElement.decode(reader, reader.uint32()))
          break
        default:
          reader.skipType(tag & 7)
          break
  ...
  toJSON(message: Paragraph): unknown {
    ...
    if (message.inlineElements) {
      obj.inlineElements = message.inlineElements.map((e) => (e ? InlineElement.toJSON(e) : undefined))
    } else {
      obj.inlineElements = []
    }
    return obj
...
const baseTextStyle: object = {bold: false, italic: false, underline: false, code: false}
...
export interface Documents {
  ...
  updateDraft(request: DeepPartial<UpdateDraftRequest>, metadata?: grpc.Metadata): Promise<UpdateDraftResponse>
  publishDraft(request: DeepPartial<PublishDraftRequest>, metadata?: grpc.Metadata): Promise<PublishDraftResponse>
  getDocument(request: DeepPartial<GetDocumentRequest>, metadata?: grpc.Metadata): Promise<GetDocumentResponse>
  listDocuments(request: DeepPartial<ListDocumentsRequest>, metadata?: grpc.Metadata): Promise<ListDocumentsResponse>
  deleteDocument(request: DeepPartial<DeleteDocumentRequest>, metadata?: grpc.Metadata): Promise<Empty>
}
...
export class DocumentsClientImpl implements Documents {
  ...
  CreateDraft(request: DeepPartial<CreateDraftRequest>, metadata?: grpc.Metadata): Promise<Document> {
    return this.rpc.unary(DocumentsCreateDraftDesc, CreateDraftRequest.fromPartial(request), metadata)
  }

  UpdateDraft(request: DeepPartial<UpdateDraftRequest>, metadata?: grpc.Metadata): Promise<UpdateDraftResponse> {
    return this.rpc.unary(DocumentsUpdateDraftDesc, UpdateDraftRequest.fromPartial(request), metadata)
  }

  PublishDraft(request: DeepPartial<PublishDraftRequest>, metadata?: grpc.Metadata): Promise<PublishDraftResponse> {
    return this.rpc.unary(DocumentsPublishDraftDesc, PublishDraftRequest.fromPartial(request), metadata)
  }

  GetDocument(request: DeepPartial<GetDocumentRequest>, metadata?: grpc.Metadata): Promise<GetDocumentResponse> {
    return this.rpc.unary(DocumentsGetDocumentDesc, GetDocumentRequest.fromPartial(request), metadata)
  }

  ListDocuments(request: DeepPartial<ListDocumentsRequest>, metadata?: grpc.Metadata): Promise<ListDocumentsResponse> {
    return this.rpc.unary(DocumentsListDocumentsDesc, ListDocumentsRequest.fromPartial(request), metadata)
  }

  DeleteDocument(request: DeepPartial<DeleteDocumentRequest>, metadata?: grpc.Metadata): Promise<Empty> {
    return this.rpc.unary(DocumentsDeleteDocumentDesc, DeleteDocumentRequest.fromPartial(request), metadata)
  }
}
