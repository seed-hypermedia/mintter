...
export function toInlineElement(entry: EntryInlineElementTextRun | EntryInlineElementQuote | EntryInlineElementImage) {
  if (Object.keys(entry).length > 1) {
    throw Error(`toInlineElement Error: invalid entry. you should send just oneOf the content type`)
  }
