...
export const GenSeedRequest = {
  ...
  fromJSON(object: any): GenSeedRequest {
    ...
    message.aezeedPassphrase =
      object.aezeedPassphrase !== undefined && object.aezeedPassphrase !== null ? String(object.aezeedPassphrase) : ''
    return message
  },
  ...
  fromPartial<I extends Exact<DeepPartial<GenSeedRequest>, I>>(object: I): GenSeedRequest {
    const message = {...baseGenSeedRequest} as GenSeedRequest
...
export const GenSeedResponse = {
  ...
  fromPartial<I extends Exact<DeepPartial<GenSeedResponse>, I>>(object: I): GenSeedResponse {
    const message = {...baseGenSeedResponse} as GenSeedResponse
...
export const Info = {
  ...
  fromJSON(object: any): Info {
    ...
    message.startTime =
      object.startTime !== undefined && object.startTime !== null ? fromJsonTimestamp(object.startTime) : undefined
    return message
  },
