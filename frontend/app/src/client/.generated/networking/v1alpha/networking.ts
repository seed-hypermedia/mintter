...
export const StartObjectDiscoveryRequest = {
  ...
  fromJSON(object: any): StartObjectDiscoveryRequest {
    ...
    message.objectId = object.objectId !== undefined && object.objectId !== null ? String(object.objectId) : ''
    return message
  },
  ...
  fromPartial<I extends Exact<DeepPartial<StartObjectDiscoveryRequest>, I>>(object: I): StartObjectDiscoveryRequest {
    const message = {
      ...baseStartObjectDiscoveryRequest,
    } as StartObjectDiscoveryRequest
...
export const StartObjectDiscoveryResponse = {
  ...
  fromPartial<I extends Exact<DeepPartial<StartObjectDiscoveryResponse>, I>>(_: I): StartObjectDiscoveryResponse {
    const message = {
      ...baseStartObjectDiscoveryResponse,
    } as StartObjectDiscoveryResponse
    return message
...
export const StopObjectDiscoveryRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<StopObjectDiscoveryRequest>, I>>(object: I): StopObjectDiscoveryRequest {
    const message = {
      ...baseStopObjectDiscoveryRequest,
    } as StopObjectDiscoveryRequest
    message.objectId = object.objectId ?? ''
...
export const StopObjectDiscoveryResponse = {
  ...
  fromPartial<I extends Exact<DeepPartial<StopObjectDiscoveryResponse>, I>>(_: I): StopObjectDiscoveryResponse {
    const message = {
      ...baseStopObjectDiscoveryResponse,
    } as StopObjectDiscoveryResponse
    return message
...
export const GetPeerInfoRequest = {
  ...
  fromJSON(object: any): GetPeerInfoRequest {
    const message = {...baseGetPeerInfoRequest} as GetPeerInfoRequest
    message.peerId = object.peerId !== undefined && object.peerId !== null ? String(object.peerId) : ''
    return message
  },
  ...
  fromJSON(object: any): PeerInfo {
    ...
    message.connectionStatus =
      object.connectionStatus !== undefined && object.connectionStatus !== null
        ...
        : 0
    message.accountId = object.accountId !== undefined && object.accountId !== null ? String(object.accountId) : ''
    return message
  },
...
export const ObjectDiscoveryStatus = {
  ...
  fromPartial<I extends Exact<DeepPartial<ObjectDiscoveryStatus>, I>>(object: I): ObjectDiscoveryStatus {
    const message = {...baseObjectDiscoveryStatus} as ObjectDiscoveryStatus
