...
export const CreateDraftRequest = {
  ...
  fromJSON(object: any): CreateDraftRequest {
    ...
    message.existingDocumentId =
      object.existingDocumentId !== undefined && object.existingDocumentId !== null
...
export const DeleteDraftRequest = {
  ...
  fromJSON(object: any): DeleteDraftRequest {
    const message = {...baseDeleteDraftRequest} as DeleteDraftRequest
    message.documentId = object.documentId !== undefined && object.documentId !== null ? String(object.documentId) : ''
    return message
  },
...
export const UpdateDraftRequest = {
  ...
  fromJSON(object: any): UpdateDraftRequest {
    const message = {...baseUpdateDraftRequest} as UpdateDraftRequest
    message.document =
      object.document !== undefined && object.document !== null ? Document.fromJSON(object.document) : undefined
  ...
  fromPartial<I extends Exact<DeepPartial<UpdateDraftRequest>, I>>(object: I): UpdateDraftRequest {
    const message = {...baseUpdateDraftRequest} as UpdateDraftRequest
    message.document =
      object.document !== undefined && object.document !== null ? Document.fromPartial(object.document) : undefined
    message.links = object.links?.map((e) => Link.fromPartial(e)) || []
    return message
  },
}

const baseUpdateDraftRequestV2: object = {documentId: ''}
...
export const UpdateDraftRequestV2 = {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): UpdateDraftRequestV2 {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input)
    let end = length === undefined ? reader.len : reader.pos + length
    const message = {...baseUpdateDraftRequestV2} as UpdateDraftRequestV2
    message.changes = []
    while (reader.pos < end) {
      const tag = reader.uint32()
      switch (tag >>> 3) {
  ...
  fromJSON(object: any): UpdateDraftRequestV2 {
    const message = {...baseUpdateDraftRequestV2} as UpdateDraftRequestV2
    message.documentId = object.documentId !== undefined && object.documentId !== null ? String(object.documentId) : ''
    message.changes = (object.changes ?? []).map((e: any) => DocumentChange.fromJSON(e))
    return message
  },
...
const baseDocumentChange: object = {}
...
export const DocumentChange = {
  encode(message: DocumentChange, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.op?.$case === 'addBlock') {
      DocumentChange_AddBlock.encode(message.op.addBlock, writer.uint32(26).fork()).ldelim()
    }
    if (message.op?.$case === 'moveBlock') {
      DocumentChange_MoveBlock.encode(message.op.moveBlock, writer.uint32(34).fork()).ldelim()
    }
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): DocumentChange {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input)
    let end = length === undefined ? reader.len : reader.pos + length
    const message = {...baseDocumentChange} as DocumentChange
    while (reader.pos < end) {
      const tag = reader.uint32()
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): DocumentChange {
    const message = {...baseDocumentChange} as DocumentChange
    if (object.setTitle !== undefined && object.setTitle !== null) {
      message.op = {$case: 'setTitle', setTitle: String(object.setTitle)}
    }
    if (object.setSubtitle !== undefined && object.setSubtitle !== null) {
      message.op = {
        $case: 'setSubtitle',
        setSubtitle: String(object.setSubtitle),
      }
    }
    if (object.addBlock !== undefined && object.addBlock !== null) {
      message.op = {
        $case: 'addBlock',
        addBlock: DocumentChange_AddBlock.fromJSON(object.addBlock),
      }
    }
    if (object.moveBlock !== undefined && object.moveBlock !== null) {
      message.op = {
        $case: 'moveBlock',
        moveBlock: DocumentChange_MoveBlock.fromJSON(object.moveBlock),
      }
    }
    if (object.replaceBlock !== undefined && object.replaceBlock !== null) {
      message.op = {
        $case: 'replaceBlock',
        replaceBlock: Block.fromJSON(object.replaceBlock),
      }
    }
    if (object.deleteBlock !== undefined && object.deleteBlock !== null) {
      message.op = {
        $case: 'deleteBlock',
        deleteBlock: String(object.deleteBlock),
      }
    }
    return message
  },
  ...
  toJSON(message: DocumentChange): unknown {
    ...
    message.op?.$case === 'addBlock' &&
      (obj.addBlock = message.op?.addBlock ? DocumentChange_AddBlock.toJSON(message.op?.addBlock) : undefined)
  ...
  fromPartial<I extends Exact<DeepPartial<DocumentChange>, I>>(object: I): DocumentChange {
    ...
    if (object.op?.$case === 'addBlock' && object.op?.addBlock !== undefined && object.op?.addBlock !== null) {
      message.op = {
        $case: 'addBlock',
...
const baseDocumentChange_AddBlock: object = {parent: '', leftSibling: ''}

export const DocumentChange_AddBlock = {
  encode(message: DocumentChange_AddBlock, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): DocumentChange_AddBlock {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input)
    let end = length === undefined ? reader.len : reader.pos + length
    const message = {
      ...baseDocumentChange_AddBlock,
    } as DocumentChange_AddBlock
    while (reader.pos < end) {
      const tag = reader.uint32()
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): DocumentChange_AddBlock {
    ...
    message.block = object.block !== undefined && object.block !== null ? Block.fromJSON(object.block) : undefined
    message.parent = object.parent !== undefined && object.parent !== null ? String(object.parent) : ''
    message.leftSibling =
      object.leftSibling !== undefined && object.leftSibling !== null ? String(object.leftSibling) : ''
    return message
  },
  ...
  fromPartial<I extends Exact<DeepPartial<DocumentChange_AddBlock>, I>>(object: I): DocumentChange_AddBlock {
    const message = {
      ...baseDocumentChange_AddBlock,
    } as DocumentChange_AddBlock
...
const baseDocumentChange_MoveBlock: object = {
  blockId: '',
  parent: '',
  leftSibling: '',
}
...
export const DocumentChange_MoveBlock = {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): DocumentChange_MoveBlock {
    ...
    let end = length === undefined ? reader.len : reader.pos + length
    const message = {
      ...baseDocumentChange_MoveBlock,
    } as DocumentChange_MoveBlock
    while (reader.pos < end) {
      const tag = reader.uint32()
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): DocumentChange_MoveBlock {
    ...
    message.blockId = object.blockId !== undefined && object.blockId !== null ? String(object.blockId) : ''
    message.parent = object.parent !== undefined && object.parent !== null ? String(object.parent) : ''
    message.leftSibling =
      object.leftSibling !== undefined && object.leftSibling !== null ? String(object.leftSibling) : ''
    return message
...
export const ListDraftsRequest = {
  ...
  fromJSON(object: any): ListDraftsRequest {
    ...
    message.pageToken = object.pageToken !== undefined && object.pageToken !== null ? String(object.pageToken) : ''
    return message
  },
...
export const ListDraftsResponse = {
  ...
  fromJSON(object: any): ListDraftsResponse {
    ...
    message.nextPageToken =
      object.nextPageToken !== undefined && object.nextPageToken !== null ? String(object.nextPageToken) : ''
    return message
  },
...
export const ListPublicationsResponse = {
  ...
  fromJSON(object: any): ListPublicationsResponse {
    ...
    message.publications = (object.publications ?? []).map((e: any) => Publication.fromJSON(e))
    message.nextPageToken =
      object.nextPageToken !== undefined && object.nextPageToken !== null ? String(object.nextPageToken) : ''
    return message
  },
...
const basePublication: object = {version: '', latestVersion: ''}
...
export const Publication = {
  ...
  fromJSON(object: any): Publication {
    ...
    message.latestVersion =
      object.latestVersion !== undefined && object.latestVersion !== null ? String(object.latestVersion) : ''
    return message
  },
...
export const Document = {
  ...
  fromJSON(object: any): Document {
    ...
    message.subtitle = object.subtitle !== undefined && object.subtitle !== null ? String(object.subtitle) : ''
    message.author = object.author !== undefined && object.author !== null ? String(object.author) : ''
    message.content = object.content !== undefined && object.content !== null ? String(object.content) : ''
    message.children = (object.children ?? []).map((e: any) => BlockNode.fromJSON(e))
    message.createTime =
      object.createTime !== undefined && object.createTime !== null ? fromJsonTimestamp(object.createTime) : undefined
    message.updateTime =
      object.updateTime !== undefined && object.updateTime !== null ? fromJsonTimestamp(object.updateTime) : undefined
    message.publishTime =
...
export const BlockNode = {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): BlockNode {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input)
    let end = length === undefined ? reader.len : reader.pos + length
    const message = {...baseBlockNode} as BlockNode
    message.children = []
    while (reader.pos < end) {
      const tag = reader.uint32()
      switch (tag >>> 3) {
...
const baseBlock: object = {id: '', type: '', text: ''}
...
export const Block = {
  encode(message: Block, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    Object.entries(message.attributes).forEach(([key, value]) => {
      Block_AttributesEntry.encode({key: key as any, value}, writer.uint32(42).fork()).ldelim()
    })
    return writer
  },
  ...
  fromJSON(object: any): Block {
    ...
    message.annotations = (object.annotations ?? []).map((e: any) => Span.fromJSON(e))
  ...
  toJSON(message: Block): unknown {
    ...
    if (message.annotations) {
      obj.annotations = message.annotations.map((e) => (e ? Span.toJSON(e) : undefined))
    } else {
      obj.annotations = []
    }
    obj.attributes = {}
  ...
  fromPartial<I extends Exact<DeepPartial<Block>, I>>(object: I): Block {
    ...
    message.annotations = object.annotations?.map((e) => Span.fromPartial(e)) || []
    message.attributes = Object.entries(object.attributes ?? {}).reduce<{
      [key: string]: string
    }>((acc, [key, value]) => {
      if (value !== undefined) {
...
const baseBlock_AttributesEntry: object = {key: '', value: ''}
...
export const Block_AttributesEntry = {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): Block_AttributesEntry {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input)
    let end = length === undefined ? reader.len : reader.pos + length
    const message = {...baseBlock_AttributesEntry} as Block_AttributesEntry
    while (reader.pos < end) {
      const tag = reader.uint32()
      switch (tag >>> 3) {
        case 1:
...
const baseSpan: object = {type: '', start: 0, end: 0}
...
export const Span = {
  encode(message: Span, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    Object.entries(message.attributes).forEach(([key, value]) => {
      Span_AttributesEntry.encode({key: key as any, value}, writer.uint32(34).fork()).ldelim()
    })
    return writer
  },
...
const baseSpan_AttributesEntry: object = {key: '', value: ''}

export const Span_AttributesEntry = {
  encode(message: Span_AttributesEntry, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.key !== '') {
      writer.uint32(10).string(message.key)
    }
    if (message.value !== '') {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): Span_AttributesEntry {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input)
    let end = length === undefined ? reader.len : reader.pos + length
    const message = {...baseSpan_AttributesEntry} as Span_AttributesEntry
    while (reader.pos < end) {
      const tag = reader.uint32()
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial<I extends Exact<DeepPartial<Span_AttributesEntry>, I>>(object: I): Span_AttributesEntry {
    const message = {...baseSpan_AttributesEntry} as Span_AttributesEntry
    message.key = object.key ?? ''
    message.value = object.value ?? ''
    return message
...
export const ListCitationsRequest = {
  ...
  fromJSON(object: any): ListCitationsRequest {
    const message = {...baseListCitationsRequest} as ListCitationsRequest
    message.documentId = object.documentId !== undefined && object.documentId !== null ? String(object.documentId) : ''
    message.depth = object.depth !== undefined && object.depth !== null ? Number(object.depth) : 0
    return message
  },
...
export const Link = {
  ...
  fromJSON(object: any): Link {
    const message = {...baseLink} as Link
    message.source =
      object.source !== undefined && object.source !== null ? LinkNode.fromJSON(object.source) : undefined
    message.target =
      object.target !== undefined && object.target !== null ? LinkNode.fromJSON(object.target) : undefined
    return message
  },
  ...
  fromPartial<I extends Exact<DeepPartial<Link>, I>>(object: I): Link {
    const message = {...baseLink} as Link
    message.source =
      object.source !== undefined && object.source !== null ? LinkNode.fromPartial(object.source) : undefined
    message.target =
      object.target !== undefined && object.target !== null ? LinkNode.fromPartial(object.target) : undefined
    return message
  },
}
