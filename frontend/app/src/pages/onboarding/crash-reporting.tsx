...
export function CrashReporting() {
  ...
  return (
    <OnboardingStep>
      ...
      <OnboardingStepDescription>
        Pre-release versions of Mintter automatically send anonymized crash
        reports when things go wrong. This helps us fix bugs and improve
        performance. <br />
        <br /> We strongly believe privacy is a basic human right, so the full
