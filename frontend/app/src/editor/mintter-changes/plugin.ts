...
import { createDeleteChange, createMoveChange, createReplaceChange } from '@app/client/v2/change-creators'
...
function shouldOverride(current: ChangeOperation, lastChange: ChangeOperation | undefined): boolean {
