...
/**
 * @generated from message com.mintter.accounts.v1alpha.SetAccountTrustRequest
 */
export class SetAccountTrustRequest extends Message<SetAccountTrustRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "com.mintter.accounts.v1alpha.SetAccountTrustRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
