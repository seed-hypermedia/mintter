 ...
 *
 * @generated from message com.mintter.groups.v1alpha.InitializeServerRequest
 */
export class InitializeServerRequest extends Message<InitializeServerRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "com.mintter.groups.v1alpha.InitializeServerRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message com.mintter.groups.v1alpha.InitializeServerResponse
 */
export class InitializeServerResponse extends Message<InitializeServerResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "com.mintter.groups.v1alpha.InitializeServerResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ]);
 ...
 *
 * @generated from message com.mintter.groups.v1alpha.PublishBlobsRequest
 */
export class PublishBlobsRequest extends Message<PublishBlobsRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "com.mintter.groups.v1alpha.PublishBlobsRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message com.mintter.groups.v1alpha.PublishBlobsResponse
 */
export class PublishBlobsResponse extends Message<PublishBlobsResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "com.mintter.groups.v1alpha.PublishBlobsResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ]);
 ...
 *
 * @generated from message com.mintter.groups.v1alpha.PublicSiteInfo
 */
export class PublicSiteInfo extends Message<PublicSiteInfo> {
  /**
   * P2P information for the website.
   *
   * @generated from field: com.mintter.groups.v1alpha.PeerInfo peer_info = 1;
   */
  peerInfo?: PeerInfo;
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "com.mintter.groups.v1alpha.PublicSiteInfo";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message com.mintter.groups.v1alpha.PeerInfo
 */
export class PeerInfo extends Message<PeerInfo> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "com.mintter.groups.v1alpha.PeerInfo";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
