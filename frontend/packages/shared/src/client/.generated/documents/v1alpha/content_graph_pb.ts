...
/**
 * @generated from message com.seed.documents.v1alpha.ListCitationsRequest
 */
export class ListCitationsRequest extends Message<ListCitationsRequest> {
  ...
  static readonly typeName = "com.seed.documents.v1alpha.ListCitationsRequest";
 ...
 *
 * @generated from message com.seed.documents.v1alpha.ListCitationsResponse
 */
export class ListCitationsResponse extends Message<ListCitationsResponse> {
   ...
   *
   * @generated from field: repeated com.seed.documents.v1alpha.Link links = 1;
   */
  links: Link[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "com.seed.documents.v1alpha.ListCitationsResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message com.seed.documents.v1alpha.Link
 */
export class Link extends Message<Link> {
  /**
   * Required. Describes where link originates from.
   *
   * @generated from field: com.seed.documents.v1alpha.LinkNode source = 1;
   */
  source?: LinkNode;
   ...
   *
   * @generated from field: com.seed.documents.v1alpha.LinkNode target = 2;
   */
  target?: LinkNode;
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "com.seed.documents.v1alpha.Link";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message com.seed.documents.v1alpha.LinkNode
 */
export class LinkNode extends Message<LinkNode> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "com.seed.documents.v1alpha.LinkNode";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "document_id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
