...
// @generated from file documents/v2alpha/comments.proto (package com.seed.documents.v2alpha, syntax proto3)
/* eslint-disable */
// @ts-nocheck
 ...
 *
 * @generated from message com.seed.documents.v2alpha.CreateCommentRequest
 */
export class CreateCommentRequest extends Message<CreateCommentRequest> {
   ...
   *
   * @generated from field: repeated com.seed.documents.v2alpha.BlockNode content = 3;
   */
  content: BlockNode[] = [];
  ...
  static readonly typeName = "com.seed.documents.v2alpha.CreateCommentRequest";
 ...
 *
 * @generated from message com.seed.documents.v2alpha.GetCommentRequest
 */
export class GetCommentRequest extends Message<GetCommentRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "com.seed.documents.v2alpha.GetCommentRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message com.seed.documents.v2alpha.ListCommentsRequest
 */
export class ListCommentsRequest extends Message<ListCommentsRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "com.seed.documents.v2alpha.ListCommentsRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "target", kind: "scalar", T: 9 /* ScalarType.STRING */ },
 ...
 *
 * @generated from message com.seed.documents.v2alpha.ListCommentsResponse
 */
export class ListCommentsResponse extends Message<ListCommentsResponse> {
  /**
   * List of comments.
   *
   * @generated from field: repeated com.seed.documents.v2alpha.Comment comments = 1;
   */
  comments: Comment[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "com.seed.documents.v2alpha.ListCommentsResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message com.seed.documents.v2alpha.Comment
 */
export class Comment extends Message<Comment> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "com.seed.documents.v2alpha.Comment";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
