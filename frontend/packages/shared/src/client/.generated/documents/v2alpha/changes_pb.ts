...
// @generated from file documents/v2alpha/changes.proto (package com.seed.documents.v2alpha, syntax proto3)
/* eslint-disable */
// @ts-nocheck
 ...
 *
 * @generated from message com.seed.documents.v2alpha.GetChangeInfoRequest
 */
export class GetChangeInfoRequest extends Message<GetChangeInfoRequest> {
  ...
  static readonly typeName = "com.seed.documents.v2alpha.GetChangeInfoRequest";
 ...
 *
 * @generated from message com.seed.documents.v2alpha.ListChangesRequest
 */
export class ListChangesRequest extends Message<ListChangesRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "com.seed.documents.v2alpha.ListChangesRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message com.seed.documents.v2alpha.ListChangesResponse
 */
export class ListChangesResponse extends Message<ListChangesResponse> {
  /**
   * List of changes matching the request.
   *
   * @generated from field: repeated com.seed.documents.v2alpha.ChangeInfo changes = 1;
   */
  changes: ChangeInfo[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "com.seed.documents.v2alpha.ListChangesResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message com.seed.documents.v2alpha.ChangeInfo
 */
export class ChangeInfo extends Message<ChangeInfo> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "com.seed.documents.v2alpha.ChangeInfo";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
