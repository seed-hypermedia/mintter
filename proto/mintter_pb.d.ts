...
export class InitProfileResponse extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: InitProfileResponse,
  ): InitProfileResponse.AsObject
  static serializeBinaryToWriter(
...
export class UpdateProfileResponse extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: UpdateProfileResponse,
  ): UpdateProfileResponse.AsObject
  static serializeBinaryToWriter(
...
export class ListProfilesRequest extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: ListProfilesRequest,
  ): ListProfilesRequest.AsObject
  static serializeBinaryToWriter(
...
export class ListProfilesResponse extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: ListProfilesResponse,
  ): ListProfilesResponse.AsObject
  static serializeBinaryToWriter(
...
export class GetProfileAddrsRequest extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: GetProfileAddrsRequest,
  ): GetProfileAddrsRequest.AsObject
  static serializeBinaryToWriter(
...
export class GetProfileAddrsResponse extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: GetProfileAddrsResponse,
  ): GetProfileAddrsResponse.AsObject
  static serializeBinaryToWriter(
...
export class ConnectToPeerRequest extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: ConnectToPeerRequest,
  ): ConnectToPeerRequest.AsObject
  static serializeBinaryToWriter(
...
export class ConnectToPeerResponse extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: ConnectToPeerResponse,
  ): ConnectToPeerResponse.AsObject
  static serializeBinaryToWriter(
