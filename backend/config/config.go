...
func SetupFlags(fs *flag.FlagSet, cfg *Config) {
	...
	fs.StringVar(&cfg.P2P.BootstrapPeer, "p2p.bootstrap-peers", cfg.P2P.BootstrapPeer, "Custom bootstrapping peer addresses (comma separated)")
	...
	fs.StringVar(&cfg.P2P.AddAddrs, "p2p.add-addrs", cfg.P2P.AddAddrs, "Adding extra address to announce. Comma separated")
